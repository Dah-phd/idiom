...
use super::super::Span::{Break, Text};
...
#[cfg(test)]
mod test {
    use super::super::Block::{Blockquote, CodeBlock, Header, Hr, Paragraph};
    use super::super::Span::Text;
    use super::parse_blocks;

    #[test]
    fn finds_atx_header() {
        assert_eq!(parse_blocks("### Test"), vec![Header(vec![Text("Test".to_owned())], 3)]);
    }

    #[test]
    fn finds_setext_header() {
        assert_eq!(parse_blocks("Test\n-------"), vec![Header(vec![Text("Test".to_owned())], 2)]);

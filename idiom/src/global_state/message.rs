...
impl Messages {
    ...
    pub fn render(&mut self, accent_style: ContentStyle, backend: &mut impl Backend) {
        if self.is_expaired() {
    ...
    pub fn fast_render(&mut self, accent_style: ContentStyle, backend: &mut impl Backend) {
        if !self.active {
            return;
        }
...
impl Message {
    #[inline]
    fn render(&self, line: Line, mut accent_style: ContentStyle, backend: &mut impl Backend) {
